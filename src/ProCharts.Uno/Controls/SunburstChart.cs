...
namespace ProCharts.Uno.Controls
{
    public class SunburstChart : ChartBase
    {
        ...
        public static readonly DependencyProperty RootNodesProperty =
            DependencyProperty.Register(nameof(RootNodes), typeof(IList<SunburstNode>), typeof(SunburstChart), new PropertyMetadata(default(IList<SunburstNode>?), OnPropertyChanged));

        public static readonly DependencyProperty InnerHollowRadiusPercentProperty =
            DependencyProperty.Register(nameof(InnerHollowRadiusPercent), typeof(double), typeof(SunburstChart), new PropertyMetadata(0.25, OnPropertyChanged));

        public IList<SunburstNode>? RootNodes { get => (IList<SunburstNode>?)GetValue(RootNodesProperty);
            set => SetValue(RootNodesProperty, value);
        }

        public double InnerHollowRadiusPercent { get => (double)GetValue(InnerHollowRadiusPercentProperty);
