...
namespace ProCharts.Uno.Controls
{
    public partial class TreemapChart : ChartBase
    {
        ...
        public static readonly DependencyProperty ItemsProperty =
            DependencyProperty.Register(nameof(Items), typeof(IList<TreemapItem>), typeof(TreemapChart), new PropertyMetadata(default(IList<TreemapItem>?), OnPropertyChanged));

        public IList<TreemapItem>? Items { get => (IList<TreemapItem>?)GetValue(ItemsProperty);
