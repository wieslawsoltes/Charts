...
namespace ProCharts.Uno.Controls
{
    public abstract partial class ChartBase : Grid
    {
        ...
        public void InvalidateVisual()
        {
            ...
            if (bg != null)
            {
                context.DrawRectangle(new SKPaint(bg), null, EffectivePlotArea);
            }
        ...
        protected virtual void DrawTitle(SKCanvas context, Size bounds)
        {
            ...
            var foreground = LabelForeground != null ? new SKPaint(LabelForeground) : SystemSKPaint;
        ...
        protected SKPaint SystemSKPaint
        {
            get
            {
                if (LabelForeground != null) return new SKPaint(LabelForeground);
                return new SKPaint 
                { 
