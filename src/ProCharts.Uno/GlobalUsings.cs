...
global using GradientStop = Microsoft.UI.Xaml.Media.GradientStop;
global using Color = ProCharts.Uno.Styles.Color;
global using Pen = ProCharts.Uno.Styles.Pen;
global using StreamGeometry = ProCharts.Uno.Maths.StreamGeometry;
global using StreamGeometryContext = ProCharts.Uno.Maths.PathOpenContext;
global using DrawingContext = ProCharts.Uno.Maths.DrawingContext;
