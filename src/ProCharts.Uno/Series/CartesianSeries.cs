...
namespace ProCharts.Uno.Series
{
    public abstract partial class CartesianSeries : ChartSeries
    {
        public static readonly DependencyProperty CategoryPathProperty =
            DependencyProperty.Register(nameof(CategoryPath), typeof(string), typeof(CartesianSeries), new PropertyMetadata(default(string), OnPropertyChanged));
        ...
        public abstract void RenderSeries(SeriesRenderContext context);
