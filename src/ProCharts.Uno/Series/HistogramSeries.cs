...
namespace ProCharts.Uno.Series
{
    public class HistogramSeries : CartesianSeries
    {
        public static readonly DependencyProperty BinCountProperty =
            DependencyProperty.Register(nameof(BinCount), typeof(int), typeof(HistogramSeries), new PropertyMetadata(10, OnPropertyChanged));

        public int BinCount { get => (int)GetValue(BinCountProperty);
