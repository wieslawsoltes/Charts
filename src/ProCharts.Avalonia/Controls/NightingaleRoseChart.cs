...
namespace ProCharts.Avalonia.Controls
{
    ...
    /// </summary>
    public class NightingaleRoseChart : ChartBase
    {
        ...
        public static readonly StyledProperty<double> StartAngleProperty =
            AvaloniaProperty.Register<NightingaleRoseChart, double>(nameof(StartAngle), 0.0);

        /// <summary>
        /// Defines the TotalAngle dependency property.
        /// </summary>
        public static readonly StyledProperty<double> TotalAngleProperty =
            AvaloniaProperty.Register<NightingaleRoseChart, double>(nameof(TotalAngle), 360.0);
        ...
        public static readonly StyledProperty<double> HollowRadiusProperty =
            AvaloniaProperty.Register<NightingaleRoseChart, double>(nameof(HollowRadius), 0.0);
        ...
        /// </summary>
        public AvaloniaList<RoseSeries> Series { get; } = new AvaloniaList<RoseSeries>();
        ...
        public NightingaleRoseChart()
        {
            ...
            StartAngleProperty.Changed.AddClassHandler<NightingaleRoseChart>((x, e) => x.InvalidateVisual());
            TotalAngleProperty.Changed.AddClassHandler<NightingaleRoseChart>((x, e) => x.InvalidateVisual());
            HollowRadiusProperty.Changed.AddClassHandler<NightingaleRoseChart>((x, e) => x.InvalidateVisual());
        }
